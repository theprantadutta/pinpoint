...
Pinpoint is a note-taking and organization application that allows you to:

- Create and manage notes with text, images, audio, and drawings
- Organize content with folders and tags
- Sync notes across devices (optional)
- Search and export your content
- Secure your notes with encryption and biometric locks
...
- Keep your content appropriate and legal
...
- You retain all rights to the content you create in Pinpoint
- You grant us a limited license to store, display, and sync your content as necessary to provide the service
- You are solely responsible for your content and its legality
- We do not claim ownership of your notes or creations

### Our Property

- The Pinpoint App, including its design, features, and code, is our property
- You may not copy, modify, distribute, or create derivative works without permission
- All trademarks, logos, and branding are owned by us or our licensors
...
- We encrypt your data locally and in transit
- Cloud sync is optional; you can use the App entirely offline
...
- We are not liable for data loss; you are responsible for backing up your content
...
The App integrates with third-party services (Google Sign-In, Firebase, etc.) that have their own terms and privacy policies. Your use of these services is subject to their respective agreements.
...
- Requiring you to accept the new Terms
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and Pinpoint regarding your use of the App.

## Acknowledgment

By using Pinpoint, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
